...
def obtener_paquetes(pedidos, mercaderia):
    resultado = []
    paquetes_ordenados = ordenar_paquetes(mercaderia, False)
	
    for pedido in pedidos:
        for paquete in paquetes_ordenados:
            if paquete[0] == pedido[0] and paquete[1] >= pedido[1]:
                resultado.append(paquete)
                break
        
    return resultado

def obtener_paquetes_2(pedidos, mercaderia):
    resultado = []  
...
mercaderia = []
pedidos = []
assert obtener_paquetes(pedidos, mercaderia) == []

# Caso 1
mercaderia = [("cigarrillo", 8)]
pedidos = [("cigarrillo", 6)]
assert obtener_paquetes(pedidos, mercaderia) == [("cigarrillo", 8)]

# Caso 2
mercaderia = [("cigarrillo", 8), ("cigarrillo", 5)]
pedidos = [("cigarrillo", 5)]
assert obtener_paquetes(pedidos, mercaderia) == [("cigarrillo", 5)]

# Caso 3
mercaderia = [("cigarrillo", 8), ("cigarrillo", 3), ("cigarrillo", 2)]
pedidos = [("cigarrillo", 5)]
assert obtener_paquetes_2(pedidos, mercaderia) == [("cigarrillo", 3), ("cigarrillo", 2) ]
...
assert obtener_paquetes_2(pedidos, mercaderia) == [("cigarrillo", 6), ("cigarrillo", 2)]

# Caso 5
mercaderia = [("cigarrillo", 8), ("vodka", 5)]
pedidos = [("cigarrillo", 8)]
assert obtener_paquetes_2(pedidos, mercaderia) == [("cigarrillo", 8)]

# Caso 6
mercaderia = [("cigarrillo", 8), ("vodka", 5)]
pedidos = [("cigarrillo", 8), ("vodka", 4)]
assert obtener_paquetes_2(pedidos, mercaderia) == [("cigarrillo", 8), ("vodka", 5)]

# Caso 7
mercaderia = [("cigarrillo", 8), ("cigarrillo", 3), ("cigarrillo", 2), ("vodka", 5)]
pedidos = [("cigarrillo", 5), ("vodka", 4)]
assert obtener_paquetes_2(pedidos, mercaderia) == [("cigarrillo", 3), ("cigarrillo", 2), ("vodka", 5)]
